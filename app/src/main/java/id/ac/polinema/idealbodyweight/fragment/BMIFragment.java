...
public class BMIFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final EditText massText = view.findViewById(R.id.input_massa);
        final EditText heightText = view.findViewById(R.id.input_tinggi);

        Button button = view.findViewById(R.id.btn_BMI);
            ...
            public void onClick(View view) {
                if (mListener != null) {
                    ...
                    if (!TextUtils.isEmpty(massString) && !TextUtils.isEmpty(heightString)) {
                        float berat = Float.parseFloat(massString);
                        float tinggi = Float.parseFloat(heightString);
                        BMIIndex bmi = new BMIIndex(berat, tinggi/100);
