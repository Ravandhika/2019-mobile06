...
public class MenuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button brocca_button= view.findViewById(R.id.button_brocca_index);
        Button bmi_button = view.findViewById(R.id.button_bmi);
        brocca_button.setOnClickListener(new View.OnClickListener(){
            @Override
